...
<a href="/uploads/2015/11/006_paper_rhodes_omnivision_bsi2.pdf">some documentation</a> on the chipset which displayed the spectral response (quantum efficiency, QE) in a graph (given that the OmniBSI chipset as displayed is the one residing in the OV5647). This has made things considerably easier. I used these slides to digitize the quantum efficiency of the OV5647 between 400 and 700 nm. A physical measurement will still be needed to quantify the remaining near infrared spectrum (&gt; 700 nm, data can be found on the <a href="https://github.com/bluegreen-labs/raspberry_pi_camera_responses" target="_blank">OV5647 spectral response github page</a>).
