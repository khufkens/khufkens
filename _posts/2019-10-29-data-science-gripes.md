...
The process is nicely explained in the [TensorFlow installation instructions](https://www.tensorflow.org/install/pip). You can basically take it from there and install keras in the same environment as well as all dependent packages.
