...
I teach people in project (code) management to fail gracefully. When things fail you should have an easy recovery, and a backup plan. Without change, climate change policy will not fail gracefully. The recent shoulder shrugs on reporting of a slowing Atlantic meridional overturning circulation (AMOC), an ocean current redistributing heat across the Atlantic with local and global climate importance, and only confirm this historical stance.
