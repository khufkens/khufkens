...
By consequence, mentoring has little priority outside the performative duties (happily offloaded to adjunct "teaching/adjunct" professors or post-docs when possible). Phds and post-docs are left to [fend for themselves](https://www.science.org/content/article/how-get-what-you-need-your-phd-or-postdoc-supervisor) in many cases, being left with [little or no true guidance](https://www.science.org/content/article/scientists-aren-t-trained-mentor-s-problem). In this context, students, Phds and post-docs are seen as mere cheap labour, not an opportunity to teach the next generation of scientists.
